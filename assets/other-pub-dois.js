(()=>{
  ...
  // Indexing labels are added only where the record/proceedings source provides reliable
  // evidence of Scopus coverage. WoS is intentionally not inferred from "submitted for
  // consideration" statements; it is shown only when actual WoS indexing is verified.
  const otherIndexMap={
    'Hierarchical Quantum Backbone: A Scalable and Robust Topology for Quantum Network Communication':'',
    ...
    'Enhanced Quantum Key Distribution Protocol for Secure Smart Grid Communication using Quantum Gates':'',
    'Spectral Analysis of Water Ice in Erlanger Crater, Lunar North Pole’s Permanently Shadowed Area':'Scopus',
    ...
    'Analysis of Different Cryptographic Algorithms in Cloud-based Multi-Robot Systems':'Scopus',
    ...
    'Security Issues in Fog Computing':'Scopus',
    'Review on Consensus Protocols for Blockchain':'Scopus',
    'Authentication of Robots using ECC to Access Cloud-based Services':'Scopus',
    'Visual Chaos Steganography with Fractional Transform':'',
    'Secured Map Building using ECIES and Kerberos for Cloud Based Robots':'',
    ...
    'A Brief Survey and Analysis of Multi-robot Communication and Coordination':'Scopus',
    'An Architecture for Detection of Land Mines using Swarm Robots':'',
    'Dynamic Vehicle Traffic Routing Problem: Study, Implementation and Analysis ing ACO and GA':'',
    'Robotic Services in Cloud Computing Paradigm':'Scopus',
    '“Robot-Cloud”: A Framework to Assist Heterogeneous Low Cost Robots':'Scopus',
    'Gesture Recognition and Generation for HOAP-2 Robots by Fuzzy Inference System':'',
    'Artificial Intelligence for Next Generation Computing, Volume 2 – Select Proceedings of AICTA 2024':'',
    ...
    'QIARF: Quantum-Inspired Adaptive Receiver Fusion Toward Secure Internet of Underwater Things':'',
    'Exploring the Frontier: Introduction to Quantum Computing and Quantum Cryptography':'Scopus',
    'A Systematic Analysis of Robot Path Planning and Optimization Techniques':'',
    'Deep Learning History and Evolution':'',
    'Fog Robotics: A New Perspective for Cloud-based Robots':'',
    'Patient’s Medical Data Security via bi-Chaos bi-Order Fourier Transform':'Scopus',
    'Fog Computing-based Seed Sowing Robots for Agriculture':'Scopus'
  };
  ...
  const add=()=>document.querySelectorAll('.pub').forEach(card=>{
    ...
    const index=otherIndexMap[title];
    const links=card.querySelector('.pub-links');
    if(!links)return;

    if(doi&&!card.querySelector('.pub-other-doi')){
    ...
    if(index&&!card.querySelector('.pub-other-index')){
      const a=document.createElement('span');
      a.className='pub-other-index';
      a.textContent=index;
      links.appendChild(a);
    }
  });
  ...
  style.textContent='.pub-links{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.pub-other-doi,.pub-other-index{display:inline-block!important;padding:5px 8px;border:1px solid #294158;border-radius:7px;font-size:10px;color:#7fdfe7;text-decoration:none;white-space:nowrap}.pub-other-doi:hover{color:#a9eef2;border-color:#3b607d}.pub-other-index{font-weight:600}@media(max-width:600px){.pub-other-doi,.pub-other-index{font-size:9px;padding:4px 7px}}';
